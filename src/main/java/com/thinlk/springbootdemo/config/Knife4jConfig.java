package com.thinlk.springbootdemo.config;

import com.fasterxml.jackson.databind.introspect.BeanPropertyDefinition;
import com.thinlk.springbootdemo.support.EnumDescriptor;
    ...
    public Docket docket() {
        ...
        Docket docket = new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(new ApiInfoBuilder()
                        ...
                        // 服务地址
                        .termsOfServiceUrl("http://localhost:9090/doc.html#/home")
                        // 作者及联系信息
                        .contact(new Contact("demo", "https://www.demo.com", "demo@163.com"))
                        // api版本
                        .version("1.0.0")
                        .build())
                //分组名称(微服务项目可以用微服务名分组)
